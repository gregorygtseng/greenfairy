var greenFairy = {
    ...
    makeGraph1: function(sectorCode, ownScore) {
    ...
    makeGraph2: function(sectorCode) {
       var sector = this.sectorInfo[sectorCode];
       var ownPercent = (this.climateCountsApi.resultData.Score *100)/this.overallTotal;
       var otherPercent = 100 - ownPercent;
       var graphData = [
       {   name: "Overall",
           y: otherPercent},
  ...
  overallTotal:  6528 // From http://api.climatecounts.org/1/AggregateScores.json?Year=2011&Overall=True
